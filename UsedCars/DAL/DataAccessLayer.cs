...
namespace DAL
{
    ...
    {
        private string _connString = "SERVER=172.16.0.26;PORT=3306;DATABASE=training;UID=training;PASSWORD=training;";//ConfigurationManager.ConnectionStrings["DatabaseConncet"].ConnectionString;
